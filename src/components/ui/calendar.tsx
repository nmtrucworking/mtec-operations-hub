  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected: cn(
          "bg-gold text-brand-blue shadow-sm shadow-gold/20",
          "hover:bg-gold-hover hover:text-brand-blue",
          "focus:bg-gold focus:text-brand-blue"
        ),

        day_today: "border border-gold text-gold",
