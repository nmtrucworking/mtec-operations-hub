...
6. Truyền currentUser/role từ src/App.tsx vào các view cần phân quyền, và siết lại trong Finance/AppShell để ẩn hoặc vô hiệu hóa hành động không hợp lệ theo ma trận quyền trong governance/PERMISSIONS.md.
...
9. Cập nhật governance/PERMISSIONS.md nếu cần để mô tả rõ quy tắc duyệt chi theo hàng chờ và quyền của bvh_finance/bcn trong màn tài chính.
...
- governance/PERMISSIONS.md - tài liệu quyền và quy trình
